# Awesome SAT solvers with stars
...
* MiniSAT(2003) - Famous for being good, short (2k LOC), and introducing incremental SAT, MiniSAT is still widely used. Clear and worth reading espcially version 1.12! [code](https://github.com/niklasso/minisat) ⭐ 1,188 | 🐛 40 | 🌐 C++ | 📅 2024-04-28 |  [paper](http://minisat.se/downloads/MiniSat.pdf)
* CryptoMiniSAT (2009) - Uses XOR primitive  - [code](https://github.com/msoos/cryptominisat) ⭐ 938 | 🐛 3 | 🌐 C++ | 📅 2026-09-25 | [paper](https://www.msoos.org/wordpress/wp-content/uploads/2011/03/Extending_SAT_2009.pdf)
* Kissat (2020) - -  [code](https://github.com/arminbiere/kissat) ⭐ 668 | 🐛 18 | 🌐 C | 📅 2025-10-16
* CaDiCaL (2019) - [paper](https://cca.informatik.uni-freiburg.de/papers/Biere-SAT-Competition-2018-solvers.pdf) | [code](https://github.com/arminbiere/cadical) ⭐ 610 | 🐛 28 | 🌐 C++ | 📅 2026-09-25
* Glucose (2009) -  Introduced different heuristics for SAT and UNSAT - [code](https://github.com/audemard/glucose) ⭐ 152 | 🐛 2 | 🌐 C++ | 📅 2025-12-30 | [paper](https://univ-artois.hal.science/hal-03299473/file/preprint.pdf)
...
* [gopher](https://github.com/crillab/gophersat) ⭐ 388 | 🐛 6 | 🌐 Go | 📅 2025-07-07 - solver written in Go
* [varisat](https://github.com/jix/varisat) ⭐ 291 | 🐛 25 | 🌐 Rust | 📅 2022-11-02 - solver written in Rust
* [Satch](https://github.com/arminbiere/satch) ⭐ 126 | 🐛 1 | 🌐 C | 📅 2026-02-10 - expository solver by Armin Biere
...
* [Loandra](https://github.com/jezberg/loandra) ⭐ 20 | 🐛 0 | 🌐 C++ | 📅 2026-04-23 (MaxSAT)
* [MUSer](https://github.com/meelgroup/muser) ⭐ 3 | 🐛 0 | 🌐 C++ | 📅 2019-09-11 (MUSer)
...
* [ApproxMCv6](https://github.com/meelgroup/approxmc) ⭐ 90 | 🐛 1 | 🌐 C++ | 📅 2026-09-25 (by creators of CryptoMiniSAT)
...
* CAQE - Solver is based on CEGAR not CDCL -  [code](https://github.com/ltentrup/caqe) ⭐ 42 | 🐛 6 | 🌐 Rust | 📅 2023-05-13
...
* [Z3](https://github.com/Z3Prover/z3) ⭐ 12,718 | 🐛 46 | 🌐 C++ | 📅 2026-09-26
* [Bitwuzla](https://github.com/bitwuzla/bitwuzla) ⭐ 394 | 🐛 9 | 🌐 SMT | 📅 2026-09-24 (successor to Boolector)
...
* HiGHS [project](https://highs.dev/) [code](https://github.com/ERGO-Code/HiGHS) ⭐ 1,858 | 🐛 121 | 🌐 C++ | 📅 2026-09-25
* CBC [code](https://github.com/coin-or/Cbc) ⭐ 1,015 | 🐛 168 | 🌐 C++ | 📅 2026-09-25
...
* [DRAT-Trim](https://github.com/marijnheule/drat-trim) ⭐ 72 | 🐛 17 | 🌐 C | 📅 2024-11-25 - verifier of proofs of unsatisfiability (UNSAT)

### Configuration of Solvers

* SMAC Bayesian Hyperparameter optimisation [code](https://github.com/automl/SMAC3) ⭐ 1,251 | 🐛 112 | 🌐 Python | 📅 2026-09-25
...
* Active learning for SAT Solver benchmarking [repo](https://github.com/mathefuchs/al-for-sat-solver-benchmarking) ⭐ 3 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2025-06-23
