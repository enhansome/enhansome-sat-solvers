...
* MiniSAT(2003) - Famous for being good, short (2k LOC), and introducing incremental SAT, MiniSAT is still widely used. Clear and worth reading espcially version 1.12! [code](https://github.com/niklasso/minisat) ⭐ 1,189 | 🐛 40 | 🌐 C++ | 📅 2024-04-28 |  [paper](http://minisat.se/downloads/MiniSat.pdf)
* CryptoMiniSAT (2009) - Uses XOR primitive  - [code](https://github.com/msoos/cryptominisat) ⭐ 941 | 🐛 1 | 🌐 C++ | 📅 2026-09-13 | [paper](https://www.msoos.org/wordpress/wp-content/uploads/2011/03/Extending_SAT_2009.pdf)
* Kissat (2020) - -  [code](https://github.com/arminbiere/kissat) ⭐ 667 | 🐛 18 | 🌐 C | 📅 2025-10-16
* CaDiCaL (2019) - [paper](https://cca.informatik.uni-freiburg.de/papers/Biere-SAT-Competition-2018-solvers.pdf) | [code](https://github.com/arminbiere/cadical) ⭐ 606 | 🐛 27 | 🌐 C++ | 📅 2026-09-21
...
* [ApproxMCv6](https://github.com/meelgroup/approxmc) ⭐ 90 | 🐛 1 | 🌐 C++ | 📅 2026-09-13 (by creators of CryptoMiniSAT)
...
* [Z3](https://github.com/Z3Prover/z3) ⭐ 12,703 | 🐛 51 | 🌐 C++ | 📅 2026-09-21
* [Bitwuzla](https://github.com/bitwuzla/bitwuzla) ⭐ 388 | 🐛 9 | 🌐 SMT | 📅 2026-09-18 (successor to Boolector)
...
* HiGHS [project](https://highs.dev/) [code](https://github.com/ERGO-Code/HiGHS) ⭐ 1,845 | 🐛 122 | 🌐 C++ | 📅 2026-09-19
* CBC [code](https://github.com/coin-or/Cbc) ⭐ 1,015 | 🐛 169 | 🌐 C++ | 📅 2026-09-21
...
* SMAC Bayesian Hyperparameter optimisation [code](https://github.com/automl/SMAC3) ⭐ 1,246 | 🐛 114 | 🌐 Python | 📅 2026-09-21
