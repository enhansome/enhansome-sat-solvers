...
* CryptoMiniSAT (2009) - Uses XOR primitive  - [code](https://github.com/msoos/cryptominisat) ⭐ 939 | 🐛 0 | 🌐 C++ | 📅 2026-07-21 | [paper](https://www.msoos.org/wordpress/wp-content/uploads/2011/03/Extending_SAT_2009.pdf)
* Kissat (2020) - -  [code](https://github.com/arminbiere/kissat) ⭐ 663 | 🐛 18 | 🌐 C | 📅 2025-10-16
* CaDiCaL (2019) - [paper](https://cca.informatik.uni-freiburg.de/papers/Biere-SAT-Competition-2018-solvers.pdf) | [code](https://github.com/arminbiere/cadical) ⭐ 587 | 🐛 25 | 🌐 C++ | 📅 2026-08-07
* Glucose (2009) -  Introduced different heuristics for SAT and UNSAT - [code](https://github.com/audemard/glucose) ⭐ 150 | 🐛 1 | 🌐 C++ | 📅 2025-12-30 | [paper](https://univ-artois.hal.science/hal-03299473/file/preprint.pdf)
...
* [ApproxMCv6](https://github.com/meelgroup/approxmc) ⭐ 90 | 🐛 1 | 🌐 C++ | 📅 2026-08-19 (by creators of CryptoMiniSAT)
...
* [Z3](https://github.com/Z3Prover/z3) ⭐ 12,572 | 🐛 60 | 🌐 C++ | 📅 2026-08-20
* [Bitwuzla](https://github.com/bitwuzla/bitwuzla) ⭐ 376 | 🐛 9 | 🌐 SMT | 📅 2026-08-19 (successor to Boolector)
...
* HiGHS [project](https://highs.dev/) [code](https://github.com/ERGO-Code/HiGHS) ⭐ 1,791 | 🐛 151 | 🌐 C++ | 📅 2026-08-19
* CBC [code](https://github.com/coin-or/Cbc) ⭐ 1,007 | 🐛 168 | 🌐 C++ | 📅 2026-08-17
...
* SMAC Bayesian Hyperparameter optimisation [code](https://github.com/automl/SMAC3) ⭐ 1,243 | 🐛 127 | 🌐 Python | 📅 2026-08-17
...
* Active learning for SAT Solver benchmarking [repo](https://github.com/mathefuchs/al-for-sat-solver-benchmarking) ⭐ 2 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2025-06-23
