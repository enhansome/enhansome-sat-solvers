...
* CryptoMiniSAT (2009) - Uses XOR primitive  - [code](https://github.com/msoos/cryptominisat) ⭐ 939 | 🐛 0 | 🌐 C++ | 📅 2026-08-23 | [paper](https://www.msoos.org/wordpress/wp-content/uploads/2011/03/Extending_SAT_2009.pdf)
* Kissat (2020) - -  [code](https://github.com/arminbiere/kissat) ⭐ 664 | 🐛 18 | 🌐 C | 📅 2025-10-16
* CaDiCaL (2019) - [paper](https://cca.informatik.uni-freiburg.de/papers/Biere-SAT-Competition-2018-solvers.pdf) | [code](https://github.com/arminbiere/cadical) ⭐ 590 | 🐛 25 | 🌐 C++ | 📅 2026-08-25
...
* [Z3](https://github.com/Z3Prover/z3) ⭐ 12,606 | 🐛 56 | 🌐 C++ | 📅 2026-08-26
* [Bitwuzla](https://github.com/bitwuzla/bitwuzla) ⭐ 380 | 🐛 8 | 🌐 SMT | 📅 2026-08-25 (successor to Boolector)
...
* HiGHS [project](https://highs.dev/) [code](https://github.com/ERGO-Code/HiGHS) ⭐ 1,802 | 🐛 133 | 🌐 C++ | 📅 2026-08-25
* CBC [code](https://github.com/coin-or/Cbc) ⭐ 1,008 | 🐛 168 | 🌐 C++ | 📅 2026-08-25
...
* [DRAT-Trim](https://github.com/marijnheule/drat-trim) ⭐ 71 | 🐛 17 | 🌐 C | 📅 2024-11-25 - verifier of proofs of unsatisfiability (UNSAT)

### Configuration of Solvers

* SMAC Bayesian Hyperparameter optimisation [code](https://github.com/automl/SMAC3) ⭐ 1,243 | 🐛 126 | 🌐 Python | 📅 2026-08-24
